...
document.getElementById("submitlink").addEventListener("click", function(event) {
    ...
    <section class="section-1" id="sec1">
      ...
      <div class="form-create">
        ...
        <p style="color:red;">You have already create event with this name and event category!!</p>
        <c:forEach var="cus" items="${eventDetails}">
          ...
          <div class="city-item">
              ...
              <select name="photo" style="width:80px;">
              ...
              <select name="decoration" style="width:80px;">
              ...
              <select name="light&audio" style="width:80px;">
              ...
              <select name="catering" style="width:80px;">
